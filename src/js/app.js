...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "Spidy"} ${
    variables.lastName ? variables.lastName : "Gonzalez"
  }</h1>
          <h2>${variables.role ? variables.role : "Web Developer"}</h2>
          <h3>${variables.city ? variables.city : "Fuente alvilla"} ${
    variables.country ? variables.country : "España"
          ...
          <ul class= ${
            ...
            <li><a href="https://linkedin.com/in/${
              variables.linkedin ? variables.linkedin : "John"
